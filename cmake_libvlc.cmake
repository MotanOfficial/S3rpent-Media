...
if(EXISTS "${LIBVLC_INCLUDE_DIR}" AND EXISTS "${LIBVLC_LIBRARY}")
    ...
    target_include_directories(apps3rpent_media PRIVATE ${LIBVLC_INCLUDE_DIR})
    target_link_libraries(apps3rpent_media PRIVATE ${LIBVLC_LIBRARY} ${LIBVLCCORE_LIBRARY})
    target_compile_definitions(apps3rpent_media PRIVATE HAS_LIBVLC=1)
    ...
    add_custom_command(TARGET apps3rpent_media POST_BUILD
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_directory
            ...
            "$<TARGET_FILE_DIR:apps3rpent_media>/plugins"
